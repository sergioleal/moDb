# ADR-015 — Handles de arestas e algoritmos de grafos
...
O moDb já persiste relacionamentos tipados por `Ref<T>` e `OwnedRef<T>`,
...
- A implantação serverless passa para a Fase 13 e pode expor operações de
  grafo por facades sem alterar o contrato persistente.

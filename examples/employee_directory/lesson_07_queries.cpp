...
// Builds on Lesson 6 (examples/employee_directory/lesson_06_snapshots.cpp).
// See docs/training/en/07-queries-and-indexes.md.
...
int main() {
    ...
    const auto status = lesson_07_queries(path, ids);

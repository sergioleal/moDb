...
// Builds on Lesson 8 (examples/employee_directory/lesson_08_networking.cpp).
// See docs/training/en/09-remote-operations.md.
...
int main() {
    ...
    const auto status = lesson_09_remote_operations(path, ids);
